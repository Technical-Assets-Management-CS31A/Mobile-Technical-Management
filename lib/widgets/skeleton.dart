                    ...
                    child: Column(
                      ...
                      children: const [
                        Row(
                          ...
                          children: [
                            Expanded(
                              child: SkeletonBox(height: 20, width: 120),
                            ),
                            SizedBox(width: 12),
                            SkeletonBox(height: 24, width: 80),
                          ],
...
class _SummaryCardSkeleton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      width: isMobile
          ? (MediaQuery.of(context).size.width - (horizontal * 2 + 12)) / 2
          : (MediaQuery.of(context).size.width - (horizontal * 2 + 16 * 3)) / 4,
      child: Container(
        padding: EdgeInsets.all(isMobile ? 16 : 20),
        decoration: BoxDecoration(
          color: Colors.white,
...
class _StaffSummaryCardSkeleton extends StatelessWidget {
  final bool isMobile;
  final double horizontal;

  const _StaffSummaryCardSkeleton({
    required this.isMobile,
    required this.horizontal,
  });
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      width: isMobile
          ? (MediaQuery.of(context).size.width - (horizontal * 2 + 12)) / 2
          : (MediaQuery.of(context).size.width - (horizontal * 2 + 16 * 2)) / 3,
      child: Container(
        padding: EdgeInsets.all(isMobile ? 16 : 20),
        decoration: BoxDecoration(
          color: Colors.white,
